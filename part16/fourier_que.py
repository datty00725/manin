...
class FourierSVG(Scene):
    ...
    def construct(self):
        ...
        for i in [5,10,100]:
            ...
            tit = Emoji("u1f624", "svg").scale_to_fit_width(10)
            ...
            vmobjects = [
                m for m in self.mobjects if isinstance(m, VMobject) and m is not gros_titre and m is not sub_titre
            ]

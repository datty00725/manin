...
class FourierTex(Scene):
    ...
    def get_svg_paths(self, file_name):
        ...
        svg_mob.scale_to_fit_height(20)
    ...
    def construct(self):
        ...
        self.play(
            ...
            sub_titre.animate.shift(3.5 * LEFT + 8 * UP).scale(0.3),
        )
        ...
        for i in [5,10,100]:
            ...
            vmobjects = [m for m in self.mobjects if isinstance(m, VMobject)  and m is not sub_titre]
